...
exports.generateChatBotModalPrompt = exports.generateDocumentPrompt = exports.generateNeededDocuments = exports.generateApplicationPrompt = void 0;
const generateApplicationPrompt = (data) => {
    const prompt = `
...
exports.generateApplicationPrompt = generateApplicationPrompt;
const generateNeededDocuments = (data) => {
    const prompt = `
          Siz O‘zbekiston Respublikasi hududida rasmiy murojaatnomalar matnini tayyorlovchi yordamchisiz. 
...
exports.generateNeededDocuments = generateNeededDocuments;
const generateDocumentPrompt = (data) => {
    const prompt = `
            Siz O‘zbekiston Respublikasi hududida rasmiy murojaatnomalar matnini tayyorlovchi yordamchisiz. 
...
exports.generateDocumentPrompt = generateDocumentPrompt;
const generateChatBotModalPrompt = (data) => {
    const prompt = `
...
exports.generateChatBotModalPrompt = generateChatBotModalPrompt;
